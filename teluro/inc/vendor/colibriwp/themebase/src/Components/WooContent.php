...
//                    $self->printSidebarColumn("right");
    ...
    private function getSidebarColumnClass( $side ) {
        ...
        $classes = (array) Hooks::prefixed_apply_filters( 'woocommerce_sidebar_column_class',
    ...
    private function getMainRowClass() {
        $classes = Hooks::prefixed_apply_filters( 'woocommerce_main_row_class', array(
            'outer_class' => array(),
    ...
    private function getMainSectionClass() {
        ...
        $classes = Hooks::prefixed_apply_filters( 'woocommerce_main_section_class', array(
            'outer_class' => array(),
