...
class Customizer {
    ...
    public function prepareOptions() {
        ...
        if ( isset( $_REQUEST['colibri_export_default_options'] ) && is_admin() ) {
            $defaults = array();
    ...
    public function registerPartialRefresh( $wp_customize ) {
        ...
        Hooks::prefixed_add_filter( 'customizer_additional_js_data', function ( $value ) use ( $partials ) {
    ...
    public function registerAssets() {
        ...
        wp_register_script( $customizer_handle,
        ...
        wp_localize_script( $customizer_handle, 'colibri_Customizer_Data',
            Hooks::prefixed_apply_filters( 'customizer_js_data', array(
                ...
                'colibri_autofocus_aliases' => (object) Hooks::prefixed_apply_filters( 'customizer_autofocus_aliases',
                    array() )
            ) ) );

        wp_register_style( $customizer_handle,
    ...
    public function previewInit() {
        ...
        wp_enqueue_style( $customizer_prevew_handle,
            $base_url . "/customizer/preview.css", Theme::getInstance()->getVersion() );


        wp_enqueue_script( $customizer_prevew_handle,
